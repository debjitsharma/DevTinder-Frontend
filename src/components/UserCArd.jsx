  ...
  return (
    <div className="relative w-100 rounded-3xl overflow-hidden shadow-2xl bg-white select-none">
      ...
      <div className="flex items-center justify-center gap-8 py-5 bg-white">
        ...
        {/* Reject */}
        <button className="flex items-center justify-center w-14 h-14 rounded-full border-2 border-red-400 text-red-400 hover:bg-red-100 active:scale-95 transition-all duration-150 shadow-md">
        ...
        {/* Like */}
        <button className="flex items-center justify-center w-14 h-14 rounded-full border-2 border-green-500 text-green-500 hover:bg-green-100 active:scale-95 transition-all duration-150 shadow-md">
